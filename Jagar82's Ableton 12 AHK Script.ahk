...
;Autohotkey script by Jagar82 (Based on Oversampled's Ahk Mod and Live Enhancement Suite) 

;STEPS

; 1. Download Powertoys https://github.com/microsoft/PowerToys/releases/tag/v0.81. (Or any software that allows you to remap keys. Running it at startup is recommended)
; 2. Remap any key you wish to Right Shift. I did it with < (Spanish Layout)
; 3. Feel the power ᕙ(⇀‸↼‶)ᕗ  (Don't forget that you can modify all of this to your taste and even upload it. MIT License B) )
