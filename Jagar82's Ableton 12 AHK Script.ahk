...
;3. Download and install Sharpkeys: https://github.com/randyrants/sharpkeys - https://apps.microsoft.com/store/detail/XPFFCG7M673D4F?ocid=pdpshare. Remap Right Shift and Right Alt to any key you wish . I did it with Caps Lock (RShift) and < (RAlt) (Spanish keyboard Layout). I would set Windows input method to English, but it's not a requirement.
